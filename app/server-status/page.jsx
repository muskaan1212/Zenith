  ...
  return (
    <div className="min-h-screen flex flex-col font-sans bg-[var(--color-surface)]">
      ...
      <main className="flex-1 max-w-3xl mx-auto w-full px-6 py-16">
        ...
        {/* Header */}
        <div className="mb-10">
          <p className="text-xs font-semibold uppercase tracking-widest text-[var(--color-accent)] mb-2">System</p>
          <h1 className="font-serif text-4xl font-bold text-[var(--color-foreground)] text-balance">Backend Status</h1>
          <p className="mt-3 text-[var(--color-text-muted)] text-sm">
            Live health check for the Zenith Express API running on port{' '}
            <code className="bg-[var(--color-border)] px-1.5 py-0.5 rounded text-xs font-mono">5000</code>.
